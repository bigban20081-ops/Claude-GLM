...
Получить доступ: [https://z.ai/subscribe?ic=JQKJ4LXBIX](https://z.ai/subscribe?ic=JQKJ4LXBIX)
...
Если модель не указана при установке, скрипт интерактивно спросит:

```
Выберите модель:
  1) glm-5   (рекомендуется, последняя версия)
  2) glm-4.7 (предыдущая стабильная версия)
